...
load([cd '\synthetic_results\sim2and3_TrNumVary_timeComplexity.mat'],'testMSE_DKRRC_Mean');

NcrossInd = 3:37;
Ncross = 3000:500:20000;
DivideNumSel = [1 5 9 13 17 20];
...
YLim = [0.00013 0.0007;0.00013 0.00081;0.0001 0.1;0.0001 0.1;0.00009 100; 0.00009 1e8];
for i = 1:length(DivideNumSel)
    figure(i);
    ...
    title(['Local Machines # ' num2str(DivideNumSel(i)*20)]);

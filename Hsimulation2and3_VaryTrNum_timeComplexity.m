%Simulation 3 of DKRR with Dimensionality d = 3
...
% optimal parameters
lambdacSel = [2*ones(1,3) 4*ones(1,17) 6 4 4 6*ones(1,14)];

ComNum = 50; % The number of communications
divideCross = 2:2:60; % The number of local machines
...
for vv = 1:length(NCross)
    ...
    save([loadPath '\synthetic_results\Hsim2and3_TrNum' num2str(N) '_timeComplexity.mat'],...
        'ExNum','KernelType','ComNum','divideCross','NCross',...
